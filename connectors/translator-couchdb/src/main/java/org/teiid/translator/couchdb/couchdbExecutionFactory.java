...
@Translator(name="couchdb", description="couchdb custom translator")
public class couchdbExecutionFactory extends ExecutionFactory<ConnectionFactory, Object> {

	
	public couchdbExecutionFactory() {
	}
    ...
    public ResultSetExecution createResultSetExecution(QueryExpression command, ExecutionContext executionContext, RuntimeMetadata metadata, Object connectionFactory)
    	...
    	return new couchdbExecution((Select)command);
    }    
